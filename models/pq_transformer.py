...
class PQ_Transformer(nn.Module):
    def __init__(self, input_feature_dim,num_class,num_proposal,num_quad_proposal,num_heading_bin,num_size_cluster,mean_size_arr,sampling='vote',num_layer=6,aux_loss=False,decoder_num = 1):
