...
import pc_util
from model_util_scannet import rotate_aligned_boxes,rotate_quad

from model_util_scannet import ScannetDatasetConfig
from scannet_planes import get_quads
...
class ScannetDetectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        instance_bboxes = np.load(os.path.join(self.data_path, scan_name)+'_bbox.npy')  # (cx,cy,cz,dx,dy,dz,semantic_label)
